        ...
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden perspective-1000 bg-[#020617]">
            ...
            >
                ...
                <div
                    ...
                    style={{
                        background: 'linear-gradient(135deg, rgba(20, 10, 5, 0.9) 0%, rgba(10, 5, 2, 0.95) 100%)', // Much darker, warm tone
                        backdropFilter: 'blur(20px)',
                        boxShadow: '0 20px 50px -12px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(249, 115, 22, 0.2)' // Orange ring
                    }}
                >
                    ...
                    <div className="absolute inset-0 rounded-3xl p-[2px] bg-gradient-to-br from-orange-500 via-transparent to-amber-600 opacity-100 pointer-events-none -z-10" style={{
                    ...
                    <div className="absolute -top-20 -left-20 w-40 h-40 bg-orange-500/20 blur-[50px] rounded-full pointer-events-none"></div>
                    <div className="absolute -bottom-20 -right-20 w-40 h-40 bg-amber-500/20 blur-[50px] rounded-full pointer-events-none"></div>
                    ...
                    <div className="flex flex-col items-center mb-8" style={{ transform: "translateZ(30px)" }}>
                        ...
                        <div className="relative mb-3 group cursor-pointer">
                            <div className="absolute inset-0 bg-orange-500 blur-xl opacity-20 group-hover:opacity-40 transition-opacity duration-500 rounded-full"></div>
                            {/* Logo Container */}
                            <div className="relative w-14 h-14 bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl border border-orange-500/30 flex items-center justify-center shadow-[0_0_15px_rgba(249,115,22,0.15)] group-hover:scale-105 transition-transform duration-300">
                            ...
                            <div className="absolute -top-1 -left-1 w-2 h-2 border-t border-l border-orange-500 rounded-tl-sm"></div>
                            <div className="absolute -bottom-1 -right-1 w-2 h-2 border-b border-r border-orange-500 rounded-br-sm"></div>
                        </div>

                        <div className="flex items-center gap-3 mb-1">
                            <h1 className="text-xl font-bold tracking-wider text-white drop-shadow-md">
                                SECURE<span className="text-orange-400 drop-shadow-[0_0_5px_rgba(249,115,22,0.8)]">FLOW</span>
                            </h1>
                        </div>
                        <p className="text-orange-200/60 text-[9px] tracking-[0.2em] uppercase font-medium">Access Secure Environment</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-2 relative group" style={{ transform: "translateZ(20px)" }}>
                            ...
                            <div className="relative overflow-hidden rounded-lg transition-all duration-300 group-hover:shadow-[0_0_15px_rgba(6,182,212,0.15)]">
                                ...
                                <input
                                    type="text"
                                    className="relative w-full bg-transparent border border-white/10 rounded-lg px-4 py-3 text-white text-sm focus:outline-none focus:border-orange-500/50 focus:ring-1 focus:ring-orange-500/50 transition-all placeholder-white/10 font-light"
                                ...
                                />
                                {/* Glow under input */}
                                <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-orange-500 to-transparent opacity-0 group-focus-within:opacity-100 transition-opacity duration-300"></div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2 relative group" style={{ transform: "translateZ(20px)" }}>
                            ...
                            <div className="relative overflow-hidden rounded-lg transition-all duration-300 group-hover:shadow-[0_0_15px_rgba(168,85,247,0.15)]">
                                ...
                                <input
                                    type="password"
                                    className="relative w-full bg-transparent border border-white/10 rounded-lg px-4 py-3 text-white text-sm focus:outline-none focus:border-amber-500/50 focus:ring-1 focus:ring-amber-500/50 transition-all placeholder-white/10 tracking-widest font-light"
                                    placeholder="••••••••••"
                                ...
                                />
                                {/* Bottom line glow */}
                                <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-amber-500 to-transparent opacity-0 group-focus-within:opacity-100 transition-opacity duration-300"></div>
                            </div>
                        </div>
                        ...
                        >
                            <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-red-500 to-amber-600 animate-gradient-x"></div>
                    ...
                    <div className="mt-8 text-center" style={{ transform: "translateZ(10px)" }}>
                        <p className="text-[9px] text-orange-500/50 uppercase tracking-[0.3em] font-semibold animate-pulse">
